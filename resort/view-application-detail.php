...
<html>
<head>
<title>Resort Booking Management System | Resort :: View Booking Detail</title>
	...
	<div class="typography">
			...
			<div class="container">
				<div class="typography-info">
					<h2 class="type">My Resort Booking Detail</h2>
				</div>
...
<center> <form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_K3BlWw21MYpR7X" async> </script> </form>
</center>
<center> <a href="invoice.php?invid=<?php echo htmlentities ($row->tid);?>" class="btn btn-success">Invoice</a>  
</center>
				</div>
