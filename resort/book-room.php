...
<html>
<head>
<title>Resort Booking Management System | Resort :: Book Room</title>
...
{               ?>
								...
								<select  type="text" value="" class="form-control" name="idtype" required="true" class="form-control">
                                 ...
                                 <p style="text-align: left;"> <input type="radio" name="gender" id="gender" value="Male"> Male <checked="true"></p>
